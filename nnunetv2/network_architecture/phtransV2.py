...
#     model = PHTrans([64,192,160],32,17)
#     total_params = sum(p.numel() for p in model.parameters())
#     print("Total Parameters:", total_params)    
#     dummy_input = torch.randn(1, 32, 64, 192, 160)
#     with torch.no_grad():
#         flops = torch.ops.profiler.profile(model, (dummy_input,), verbose=True)
#     print("Total FLOPs (Floating Point Operations):", flops)