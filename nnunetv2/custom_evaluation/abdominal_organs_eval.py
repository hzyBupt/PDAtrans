...
# /ai/code/nnUNet/nnunetv2/custom_evaluation/SurfaceDice.py
...
def abdominal_organs_eval(task,experiment_id):
    ...
    network_training_output_dir = '/ai/code/nnUNet_trained_models/nnUNet/'
    nnUNet_raw_data = '/ai/data/nnUNet_raw/nnUNet_raw_data'
    join = os.path.join
    ...
    if task == 180:
        ...
        # /ai/code/nnUNet_trained_models/nnUNet/3d_fullres/Task180_WORD/PHTransTrainer__nnUNetPlansv2.1/fold_0
...
if __name__ == '__main__':
    ...
    parser.add_argument("--ei", help='tag of experiment id',default="nnFormer3_230202_034055")
