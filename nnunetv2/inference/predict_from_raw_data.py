...
def predict_entry_point():
    ...
    args = parser.parse_args()
    args.f = [i if i == 'all' else int(i) for i in args.f]
    args.i = join(nnUNet_raw, maybe_convert_to_dataset_name(args.d),"imagesTs") if args.i == None else args.i
    model_folder = get_output_folder(args.d, args.tr, args.p, args.c) 
    args.o = join(model_folder,f"fold_{args.f[0]}",args.experiment_id,args.chk.split('.')[0],) if args.o == None else args.o 
