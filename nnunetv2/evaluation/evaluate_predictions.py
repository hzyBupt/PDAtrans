...
if __name__ == '__main__':
    folder_ref = '/ai/data/nnUNet_raw/nnUNet_raw_data/Task180_WORD/labelsTs'
    folder_pred = '/ai/data/project/0SAM/SAM-Med3D/data/ct_WORD/pred_sammed3d'
    output_file = '/ai/data/project/0SAM/SAM-Med3D/out/summary.json'
